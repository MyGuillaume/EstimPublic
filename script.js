const secteurs = [
    ...
    { secteur: "Kinésithérapeute - BNC", prix: 80 },
    { secteur: "Infirmier - Infirmière - SEL", prix: 150 },
    { secteur: "Kinésithérapeute - SEL", prix: 150 },
    ...
    { secteur: "SCM - Kinésithérapeute", prix: 120 },
    { secteur: "SCP - Kinésithérapeute", prix: 150 },
...
function displayPrice(price, sector) {
    ...
    <div class="note">
      <strong>Note :</strong> Ce prix est estimatif et peut varier. Il a pour but de vous informer des conditions tarifaires potentielles. 
      Nos honoraires, exclusifs de toute autre rémunération sont déterminés en fonction du niveau de responsabilité, de la nature et de la complexité des travaux effectués et du temps passé.
      Cette estimation ne constitue ni un devis, ni une facture, ni une lettre de mission. Une lettre de mission devra être établie et signée avant toute intervention de notre part.
    </div>
    `;
}
